...
function updateClue(t, n) {
  ...
  switch (clueElement.Type) {
    case "Text":
      ...
      break;
    case "Image":
      document.querySelector(`[id=question-template]`
      ).innerHTML = `<p>${clueElement.Clue}</p>
      <img src=\"media/${clueElement.File}\" class=\"r-stretch\"></img><aside class=\"notes\" id=\"temp-notes1\">template notes 📝</aside>`;
      break;
    case "Video":
      document.querySelector(
        `[id=question-template]`
      ).innerHTML = `<p>${clueElement.Clue}</p>
      <video id=\"media\" src=\"media/${clueElement.File}\" class=\"r-stretch\"></video><aside class=\"notes\" id=\"temp-notes1\">template notes 📝</aside>`
       break;     
    case "Gif":
      document.querySelector(
        `[id=question-template]`
    ...
    case "Audio":
      ...
      <audio controls id=\"media\" src=\"media/${clueElement.File}\"></audio><aside class=\"notes\" id=\"temp-notes1\">template notes 📝</aside>`;
      break;
  }
